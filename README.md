...
| <img src="fan-lid-spring-latch/renders/isometric_view.png" width="160" alt="Fan Lid with Spring Latch"> | **[fan-lid-spring-latch](fan-lid-spring-latch/)**<br>風扇快拆蓋子 (雙側彈片防脫落改良版 - 咬合摩擦夾持版) | 針對風扇轉接蓋（蓋子9.stl）的抗疲勞防鬆脫改良。完全取消傳統底扣卡榫（絕不頂死），將彈片維持於側面，內壁增設 4 道水平微齒（咬合摩擦力），利用彈片微撓彈性兼顧列印容差並提供強大夾持力。 | • 完全無底扣卡榫 (底部直通平滑，徹底告別插拔頂死/卡滯)<br>• 純側面彈片 (底板保持 91% 實心剛性，維持全框高強度)<br>• 內壁 4 道水平咬合微齒 (微凸 0.30mm，過盈 0.20mm 緊密咬合)<br>• 兼顧列印公差 (彈片自主吸收 ±0.2mm 公差並持續提供預緊力)<br>• 彈片頂端加高 2.5mm 拇指按鍵 + 25° 導引斜坡，100% 免支撐水密直印 | [📖 說明](fan-lid-spring-latch/README.md)<br>[📦 STL 套件](fan-lid-spring-latch/fan_lid_kit_raised_thumb.stl)<br>[📦 STL 單件](fan-lid-spring-latch/fan_lid_spring_raised_thumb.stl) |
