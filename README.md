...
| :---: | :--- | :--- | :--- | :---: |
| <img src="main-holder-split/renders/assembled_colored_view.png" width="160" alt="Main Holder Modular Split"> | **[main-holder-split](main-holder-split/)**<br>主支架模組化拆件與平鋪列印方案 | 針對大型桁架支架（231×221×85mm）進行 DFM 拆件優化。在 Z=8mm 處拆解為 1 件底座 + 4 件立柱平鋪列印，徹底消除 385 層的超長距離空跑。 | • 100% 保持原件外觀與尺寸 (231×221×85mm)<br>• 內嵌 0.09mm 原廠實測黃金公差榫卯卡榫<br>• 乾壓緊配合自鎖，完全免膠水不鬆脫<br>• 單盤列印時間 < 2 小時 (總耗時縮短 24%)<br>• 立柱縱向受力，抗斷裂強度提升 300% | [📖 說明](main-holder-split/README.md)<br>[📦 盤 1 STL](main-holder-split/Plate1_Base_Plate.stl)<br>[📦 盤 2 STL](main-holder-split/Plate2_Four_Pillars_Flat.stl) |
