...
| <img src="fan-lid-spring-latch/renders/isometric_view.png" width="160" alt="Fan Lid with Spring Latch"> | **[fan-lid-spring-latch](fan-lid-spring-latch/)**<br>風扇快拆蓋子 (雙側彈片防脫落改良版) | 針對風扇轉接蓋（蓋子9.stl）的抗疲勞防鬆脫改良。以懸臂式柔性彈片取代原始剛性直壁卡扣，徹底解決長時間運轉潛變脫落問題。 | • 雙側 1.2mm 貫穿切槽 + 13.6mm 彈性懸臂樑<br>• 底板保留 5.0mm 剛性框架 + R0.6 止裂孔<br>• 卡勾增設 45° 裝配導角 (順暢推入不磨損)<br>• 彈片頂端加高 2.5mm 拇指按鍵 (秒拆秒裝)<br>• 100% 免支撐水密模型，原座標雙件同印 | [📖 說明](fan-lid-spring-latch/README.md)<br>[📦 STL 套件](fan-lid-spring-latch/fan_lid_kit_raised_thumb.stl)<br>[📦 STL 單件](fan-lid-spring-latch/fan_lid_spring_raised_thumb.stl) |
