...
| <img src="fan-lid-spring-latch/renders/isometric_view.png" width="160" alt="Fan Lid with Spring Latch"> | **[fan-lid-spring-latch](fan-lid-spring-latch/)**<br>風扇快拆蓋子 (雙側彈片防脫落改良版 - v2精密修正) | 針對風扇轉接蓋（蓋子9.stl）的抗疲勞防鬆脫改良。經回饋優化，將底板切槽大幅縮短至 3.6mm（消除過鬆），並修除過厚突起改為 0.55mm 微凸卡齒（有效咬合 0.45mm），徹底解決長時間運轉脫落且保證順暢卡入。 | • 雙側 1.0mm 切槽 + 3.6mm 緊湊懸臂 (抗彎剛度提升 30 倍，手感堅挺)<br>• 底板保留 15.0mm 完整剛性框架 + R0.5 應力止裂孔<br>• 0.55mm 精密微凸卡齒 (有效咬合 0.45mm，完美咬入底座 1.0mm 倒角絕不頂死)<br>• 彈片頂端加高 2.5mm 拇指按鍵 + 22° 滑順導引斜坡 (秒拆秒裝)<br>• 100% 免支撐水密模型，原座標雙件同盤直印 | [📖 說明](fan-lid-spring-latch/README.md)<br>[📦 STL 套件](fan-lid-spring-latch/fan_lid_kit_raised_thumb.stl)<br>[📦 STL 單件](fan-lid-spring-latch/fan_lid_spring_raised_thumb.stl) |
