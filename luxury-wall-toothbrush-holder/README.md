...
- **設計語彙**：後排高階立面與側壁環繞立體縱向羅馬柱凸槽紋理（Pitch 4.8mm, R 1.4mm），前排展台維持絲綢般溫潤光潔的極簡曲面，形成「古典後壁與現代展台」的奢華材質對比。
...
| 檔案名稱 | 說明 | 推薦用途 |
| :--- | :--- | :--- |
| **[`luxury_holder_fluted.stl`](luxury_holder_fluted.stl)** | **羅馬柱豎條紋前推懸掛置物架主體 (★推薦)** | 經典輕奢立體凸柱紋，最能完美展現玫瑰金絲綢拉絲光澤，2 電動 + 2 手動防掉孔 + 2 超大牙膏倉。 |
| **[`combo_plate_fluted.stl`](combo_plate_fluted.stl)** | **整盤雙件同印組合檔 (一鍵開印)** | 羅馬柱主體 + 快拆背板同盤排列（佔用 $160 \times 116\text{mm}$），單次搞定整套，開箱即印！ |
