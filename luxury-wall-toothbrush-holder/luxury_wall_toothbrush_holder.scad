            ...
            minkowski() {
                difference() {
                    ...
                    translate([d_proj * 0.54, 0, 22.5])
                        rotate([0, 90, 90])
                            cylinder(r=13.5, h=w_base * 1.5, center=true, $fn=48);
                    ...
                    translate([th_bevel + 8.5, 0, h_base/2 + 6.5])
                        rotate([0, 75, 0])
                            scale([1.0, 1.45, 0.75])
                                cylinder(r=13.0, h=w_base * 1.5, center=true, $fn=48);
                }
