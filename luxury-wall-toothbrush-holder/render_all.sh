...
openscad --csglimit=1000000 --camera=0,35,35,58,0,195,1300 --imgsize=1600,900 --colorscheme=Cornfield \
...
openscad --csglimit=1000000 --camera=0,40,35,58,0,205,580 --imgsize=1600,1000 --colorscheme=Cornfield \
...
echo "Rendering Temple Palais Multi-Angle Clean Views..."
openscad --render --csglimit=1000000 --camera=0,50,90,35,0,25,360 --imgsize=1600,1000 --colorscheme=Cornfield \
    -D 'style="fluted"' -D 'mode="holder"' -o "$RENDERS/fluted_crystalline_top.png" "$SCAD"

openscad --render --csglimit=1000000 --camera=0,65,-10,125,0,210,360 --imgsize=1600,1000 --colorscheme=Cornfield \
    -D 'style="fluted"' -D 'mode="holder"' -o "$RENDERS/fluted_crystalline_bottom.png" "$SCAD"

openscad --render --csglimit=1000000 --camera=70,40,40,90,0,90,260 --imgsize=1600,1000 --colorscheme=Cornfield \
    -D 'style="fluted"' -D 'mode="holder"' -o "$RENDERS/fluted_crystalline_side.png" "$SCAD"

openscad --render --csglimit=1000000 --camera=0,65,42,90,0,180,280 --imgsize=1600,1000 --colorscheme=Cornfield \
    -D 'style="fluted"' -D 'mode="holder"' -o "$RENDERS/fluted_crystalline_front.png" "$SCAD"

openscad --render --csglimit=1000000 --camera=-80,80,60,60,0,225,340 --imgsize=1600,1000 --colorscheme=Cornfield \
    -D 'style="fluted"' -D 'mode="holder"' -o "$RENDERS/fluted_crystalline_iso_front.png" "$SCAD"

openscad --render --csglimit=1000000 --camera=-80,80,-30,120,0,225,340 --imgsize=1600,1000 --colorscheme=Cornfield \
    -D 'style="fluted"' -D 'mode="holder"' -o "$RENDERS/fluted_crystalline_iso_under.png" "$SCAD"

echo "Rendering Front Tier Ergonomic Detail..."
openscad --render --csglimit=1000000 --camera=0,50,45,65,0,205,260 --imgsize=1600,1000 --colorscheme=Cornfield \
...
openscad --render --csglimit=1000000 --camera=0,58,35,60,0,205,420 --imgsize=1600,1000 --colorscheme=Cornfield \
