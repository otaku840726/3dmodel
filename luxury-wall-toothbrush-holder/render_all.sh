...
echo "2. Rendering Assembled Perspectives with Large Thick Circular Caps..."
openscad --csglimit=1000000 --camera=0,50,40,58,0,205,750 --imgsize=1600,1000 --colorscheme=Cornfield \
...
openscad --render --csglimit=1000000 --camera=0,55,50,55,0,205,450 --imgsize=1600,1000 --colorscheme=Cornfield \
...
openscad --render --csglimit=1000000 --camera=70,45,45,90,0,90,320 --imgsize=1600,1000 --colorscheme=Cornfield \
    -D 'edition="grand"' -D 'style="fluted"' -D 'mode="holder"' -o "$RENDERS/fluted_crystalline_side.png" "$SCAD"

openscad --render --csglimit=1000000 --camera=0,65,44,90,0,180,340 --imgsize=1600,1000 --colorscheme=Cornfield \
    -D 'edition="grand"' -D 'style="fluted"' -D 'mode="holder"' -o "$RENDERS/fluted_crystalline_front.png" "$SCAD"

openscad --render --csglimit=1000000 --camera=-80,85,65,60,0,225,450 --imgsize=1600,1000 --colorscheme=Cornfield \
    -D 'edition="grand"' -D 'style="fluted"' -D 'mode="holder"' -o "$RENDERS/fluted_crystalline_iso_front.png" "$SCAD"

openscad --render --csglimit=1000000 --camera=-80,85,-30,120,0,225,450 --imgsize=1600,1000 --colorscheme=Cornfield \
...
openscad --render --csglimit=1000000 --camera=0,60,45,65,0,205,320 --imgsize=1600,1000 --colorscheme=Cornfield \
...
openscad --render --csglimit=1000000 --camera=0,70,40,60,0,205,520 --imgsize=1600,1000 --colorscheme=Cornfield \
