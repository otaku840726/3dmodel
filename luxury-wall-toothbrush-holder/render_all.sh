...
openscad --camera=0,0,15,62,0,195,950 --imgsize=1600,900 --colorscheme=Cornfield \
    -D 'mode="all_styles"' -o "$RENDERS/rose_gold_3styles_comparison.png" "$SCAD"

echo "Rendering Fluted Assembled Perspective..."
openscad --camera=0,25,20,58,0,205,390 --imgsize=1600,1000 --colorscheme=Cornfield \
...
openscad --camera=0,45,25,65,0,205,260 --imgsize=1600,1000 --colorscheme=Cornfield \
    -D 'style="fluted"' -D 'mode="holder"' -o "$RENDERS/front_tier_ergo_detail.png" "$SCAD"

echo "Rendering Wall Bracket Detail..."
openscad --camera=0,0,5,55,0,45,180 --imgsize=1600,1000 --colorscheme=Cornfield \
    -D 'mode="bracket"' -o "$RENDERS/wall_bracket_mounting.png" "$SCAD"

echo "Rendering 1-Plate Combo Print Bed Layout..."
openscad --camera=15,25,10,58,0,210,480 --imgsize=1600,1000 --colorscheme=Cornfield \
